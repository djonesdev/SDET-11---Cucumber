...
class BbcSignInPage
  ...
  attr_accessor :login_error_text, :password_error_text
  ...
  def initialize
    ...
    @password_error_text = "U oh, that password doesn't match that account. Please try again."
  end
  ...
  PASSWORD_ERROR ||= '.field_input_container'
  PASSWORD_ERROR_MESSAGE_ID ||= ''
